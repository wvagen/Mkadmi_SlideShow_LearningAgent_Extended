...
public class MS_SlideShow_Canvas_v2 : MonoBehaviour
{

    private List<MS_SlideShow_Page_v2> pages;
    private MS_SlideShow_Page_v2 currentPage;
    ...
    void Init()
    {
        pages = new List<MS_SlideShow_Page_v2>();
        currentPageIndex = 0;
    }
    ...
    void Set_Pages()
    {
        ...
        {
            if (transform.GetChild(i).GetComponent<MS_SlideShow_Page_v2>() != null)
            {
                pages.Add(transform.GetChild(i).GetComponent<MS_SlideShow_Page_v2>());
            }
        }
    }
